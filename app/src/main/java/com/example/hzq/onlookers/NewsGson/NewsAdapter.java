...
public class NewsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tvTitle = (TextView) convertView.findViewById(R.id.ntitle);
        TextView tvAuth = (TextView) convertView.findViewById(R.id.nauth);
        TextView tvTime = (TextView) convertView.findViewById(R.id.ntime);
        ImageView ivPic = (ImageView) convertView.findViewById(R.id.nPic);
